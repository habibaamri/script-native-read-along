...
function highlight(item){
  ...
  if(args.object.get('dataBegin') <= currentTime && args.object.get('dataEnd') > currentTime){
    console.log("YEA");
...
var array = new observableArray.ObservableArray();
 array.push( [
  ...
  { "id" : 2, "item": "those", "begin" : "0.929", "end": "1.209","color":"lightgray"},
  ...
  { "id" : 6, "item": "went", "begin" : "2.165", "end": "2.356","color":"lightgray"},
  ...
  { "id" : 12, "item": "all", "begin" : "4.216", "end": "4.484","color":"#fff"},
...
exports.pageLoaded = function(args) {
  ...
  var x=page.bindingContext = { myItems: array };

  player.playFromFile(playerOptions)
        .then(function (res) {
            if (player.isAudioPlaying()==true) {
...
console.log(player.currentTime+"begin");

  if(entry.begin <= player.currentTime
   && entry.end> player.currentTime){
  console.log("YEA");
  return {};
}else{
